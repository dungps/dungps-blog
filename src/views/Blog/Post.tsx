...
const PostComponent = ({ match, history }: RouteComponentProps<{ slug: string }>) => {
                ...
                {loading ? (
                    ...
                    <section className='pt-8 pt-md-11'>
                        <div className='container'>
                            ...
                            <div className='row justify-content-center'>
                                <div className='col-12 col-md-10 col-lg-9 col-xl-8'>
                                    <div className='entry-content' dangerouslySetInnerHTML={{ __html: marked(post?.content || "", { gfm: true }) }} />
                                </div>
                            </div>
                        </div>
                    </section>
